<style>
/* BLOCKS DE CONTENU */
#pageModMenu .infos		{text-align:left;}
...
<div id="pageFull">
	<div id="pageModuleMenu">
		<div id="pageModMenu" class="miscContainer">
			<div class="menuLine" onclick="lightboxOpen('<?= MdlSpace::getUrlNew() ?>')" <?= Txt::tooltip("SPACE_moduleTooltip") ?>><div class="menuIcon"><img src="app/img/plusSmall.png"></div><div><?= Txt::trad("SPACE_addSpace") ?></div></div>
			<?= MdlSpace::menuSort() ?>
	...
	<div id="pageFullContent" class="objBlocks">
		...
		foreach($spaceList as $tmpSpace)
		{
			...
			echo $tmpSpace->divContainerContextMenu();
				...
				$moduleList=null;
				foreach($tmpSpace->moduleList(false) as $tmpModule)  {$moduleList.='<img src="app/img/'.$tmpModule["moduleName"].'/icon.png" '.Txt::tooltip($tmpModule["description"]).'>';}
