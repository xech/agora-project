	...
	public static function actionVueEditSpace()
	{
		...
		if(Req::isParam("formValidate")){
			...
			foreach(Req::param("moduleList") as $rank=>$moduleName){
				$options=Txt::tab2txt(Req::param($moduleName."_options"));
			...
			if($curObj->isNewRecord() && in_array("calendar",Req::param("moduleList")) && Req::isParam("calendar_options") && in_array("createSpaceCalendar",Req::param("calendar_options"))){
