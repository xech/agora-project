...
$(function(){
	...
	if(Ctrl::$curUser->isUser()==false)	{echo "$('.vEventOptionAdvanced,#eventAffectations').hide();";}//Guest : masque les options avancées et masque l'affectation aux agendas (mais garde en "background")
