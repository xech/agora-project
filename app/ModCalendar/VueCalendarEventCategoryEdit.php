...
<div class="lightboxContent">
	<div class="lightboxTitle">
		<img src="app/img/category.png"> <?= Txt::trad("CALENDAR_editCategories") ?>
		<div class="lightboxTitleDetail"><img src="app/img/info.png"> <?= Txt::trad("CALENDAR_editCategoriesRight") ?></div>
	</div>
	<div class="lightboxAddElem">
		<button onclick="$('form:first-of-type').slideToggle();$('form:first-of-type [name=title]').focus();"><img src="app/img/plus.png"> <?= Txt::trad("CALENDAR_addCategory") ?></button>
	</div>
	<?php
