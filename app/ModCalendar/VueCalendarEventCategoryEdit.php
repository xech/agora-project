...
<div class="lightboxContent">
	<div class="lightboxTitle">
		...
		<div id="lightboxTitleDetail"><?= Txt::trad("CALENDAR_editCategoriesRight") ?></div>
	</div>
	...
	foreach($categoriesList as $tmpCategory)
	{
		...
		$buttonsSubmitDelete=($tmpCategory->isNew())  ?  Txt::submit("add",false)  :  Txt::submit("modify",false);
