...
<div>
	...
	foreach($mailList as $tmpMail)
	{
		...
		$buttonResend="<div class='vMailDetail vMailDetailOption' onclick=\"sendOldMail('".$tmpMail->_typeId."')\" title=\"".Txt::trad("MAIL_resendInfo")."\"><img src='app/img/mail/resend.png'> ".Txt::trad("MAIL_resend")."</div>";
