	...
	<div id="invitationList">
		...
		<ul id="invitationListDiv">
			...
			foreach($invitationList as $tmpInvitation){
				...
				echo "<li>".$tmpInvitation["name"]." ".$tmpInvitation["firstName"]." - ".$tmpInvitation["mail"]." - ".Txt::dateLabel("textMini",$tmpInvitation["dateCrea"])."&nbsp; ".$deleteInvitationImg."<br><img src='app/img/arrowRightSmall.png' style='height:8px'> ".$objSpace->name."</li>";
			}
			?>
		</ul>
	</div>
