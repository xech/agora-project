<div class="pathMenu miscContainer">
	...
	foreach($curFolderPath as $tmpKey=>$tmpFolder)
	{
		...
		echo '<div><img src="app/img/'.$leftIcon.'.png"></div><div '.$folderLink.' '.Txt::tooltip($tmpFolder->description).'>'.Txt::reduce($tmpFolder->name,40).' '.$contextMenuInline.'</div>';//Tester sur mobile avec un "name" très long
	}
