	...
	<div>
		...
		<div  class="menuContext" id="menuDisplayMode">
			...
			echo "<div class='menuLine'>
					...
					<div><a onclick=\"redir('".$displayModeUrl.$tmpDisplayMode."')\" ".($curDisplayMode==$tmpDisplayMode?"class='sLinkSelect'":null).">".Txt::trad("displayMode")." ".Txt::trad("displayMode_".$tmpDisplayMode)."</a></div>
				</div>";
			}
			?>
		</div>
