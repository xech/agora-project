...
<img src="app/img/loading.gif" style="position:absolute;bottom:50px;right:50px;z-index:10000;">
<div id="mapid"></div>
...
$(function(){
	...
	//// Instancie la carte LEAFLET
		...
		L.tileLayer(layerUrl, {id:layerId, attribution:'Map data © OpenStreetMap'}).addTo(myMap);//"tile" = carte/tuile
	}
