...
.vMessageQuoted					{position:relative; display:inline-block; overflow:auto; max-height:100px; margin-bottom:20px; padding:10px; padding-left:40px; border-radius:var(--radius-field); font-style:italic; font-weight:normal; background:<?= Ctrl::$agora->skin=="black"?"#333":"#eee" ?>;}
