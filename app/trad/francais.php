...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"confirmDeleteAlert"=>"Attention : cette action est définitive",
			...
			"CALENDAR_proposeEvtTooltip"=>"Proposer un événement pour cet agenda accessible en lecture : doit être validé par le propriétaire de l'agenda",
			"CALENDAR_proposeOptionTooltip"=>"Option pour proposer l'événement : doit être validé par le propriétaire de l'agenda",
