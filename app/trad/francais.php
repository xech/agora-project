...
class Trad extends Txt
{
	...
	public static function loadTradsLang()
	{
		...
		self::$trad=array(
			...
			"NOTIF_presentIp"=>"Ce compte utilisateur est actuellement utilisé depuis un autre ordinateur, avec une autre adresse ip. Un compte ne peut être utilisé que sur un seul ordinateur en même temps.",
			"NOTIF_noSpaceAccess"=>"Votre compte utilisateur a bien été identifié, mais vous n'êtes actuellement affecté à aucun espace. Merci de contacter l'administrateur pour vérifier vos droits d'accès",
			...
			"HEADER_displayAdminInfo"=>"Afficher tous les éléments présents sur cet espace (réservé aux admins)",
			...
			"EDIT_notifMailAddFiles"=>"Joindre les fichiers à la notification",
			...
			"INSTALL_dbErrorDbName"=>"Attention : le nom de la base de donnée doit comporter de préférence uniquement des caractères alphanumériques, tirets ou underscores",
			"INSTALL_dbErrorUnknown"=>"La connexion au serveur de base de données a échoué : merci de vérifier les coordonnées de connexion.",
			"INSTALL_dbErrorIdentification"=>"L'identification au serveur de base de données à échoué",
			"INSTALL_dbErrorAppInstalled"=>"L'application a déjà été installée sur cette base de données. Merci de supprimer la BDD si vous souhaitez relancer l'installation.",
			...
			//Edit
			"SPACE_usersAccess"=>"Utilisateurs affectés à l'espace",
			...
			"SPACE_adminInfo"=>"Administrateur d'espace : <br>- accès en écriture à tous les éléments de l'espace <br>- envoi d'invitations par email <br>- création d'utilisateurs sur l'espace <br>- paramétrage de l'espace",
			...
			"USER_adminGeneralInfo"=>"L'administrateur général peut gérer tout le paramétrage du site, tous les éléments (agendas, dossiers, fichiers, etc) ainsi que tous les utilisateurs et espaces. Il possède tous les droits : il est donc conseillé d'attribuer ce privilège à deux ou trois utilisateurs maximum.",
