...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"footerGeneratedTime"=>"Page générée en",
			...
			"displayMode_line"=>"ligne",
			"displayMode_block"=>"grille",
			...
			"beginEndError"=>"La date de fin ne peut pas être avant la date de début",
			...
			////	Envoi d'un email
			"MAIL_notifSendOk"=>"L'email a bien été envoyé",
			"MAIL_notifSendOkBis"=>"L'email de notification a bien été envoyé",
			"MAIL_notifSendFail"=>"L'email n'a pas pu être envoyé",
			"MAIL_recipients"=>"Destinataires",
			"MAIL_recipientsTooltip"=>"Choisir les destinataires de l'email",
			...
			"downloadBackToApp"=>"Retour à Omnispace",
			...
			"userInscriptionNotif"=>"Notifier les administrateurs par email à chaque nouvelle inscription",
			...
			"import_user"=>"Importer des utilisateurs sur l'espace",
			"import_contact"=>"Importer des contacts dans le dossier",
			"export_user"=>"Exporter les utilisateurs de l'espace",
			"export_contact"=>"Exporter les contacts du dossier",
			"exportFormat"=>"au format",
			"export_vcard"=>"Exporter au format vCard",
			"specifyFile"=>"Merci de spécifier un fichier",
			"fileExtension"=>"Le type de fichier n'est pas valide. Il doit être de type",
			"importContactRootFolder"=>"Les contacts importés du dossier principal sont affectés par défaut à <i>Tous les utilisateurs de l'espace</i>",
			"importInfo"=>"Pour chaque colonne, utilisez le menu de sélection pour définir le champ correspondant",
			...
			"importNotif3"=>"Ce champ à déjà été sélectionné sur une autre colonne : <br> chaque champ ne peut être sélectionné qu'une fois. <br><br> Pensez à déselectionnez d'abord l'autre champ",
			...
			"EDIT_notifMailTooltipCal"=>"<hr>Agenda personnel : envoyé uniquement aux personnes pouvant éditer l'agenda.<br>Agenda partagé : envoyé à toute personne pouvant consulter l'agenda.",
			...
			"AGORA_backupConfirm"=>"La récupération de la sauvegarde peut durer quelques minutes : confirmer tout de même ?",
			...
			"SPACE_publicSpaceRGPD"=>"Si votre espace public contient des données personnelles (nom, adresse, etc) pensez à spécifier un mot de passe pour être conforme à la RGPD",
			...
			"USER_spaceGroupsEdit"=>"Editer les groupes",
			"USER_spaceGroupsEditBis"=>"Editer les groupes d'utilisateurs de l'espace",
			...
			"USER_livecounterVisibility"=>"Présence sur la messagerie",
			...
			"DASHBOARD_OPTION_adminAddNews"=>"Seul les administrateurs peuvent ajouter de nouvelles actualités",
			"DASHBOARD_OPTION_disablePolls"=>"Désactiver les sondages",
			"DASHBOARD_OPTION_adminAddPoll"=>"Seul les administrateurs peuvent ajouter de nouveaux sondages",
			...
			"DASHBOARD_offlineNews"=>"Actualités archivées",
			"DASHBOARD_offlineNewsInfo"=>"Afficher les actualités archivées",
			"DASHBOARD_noNews"=>"Aucune actualité pour le moment",
			"DASHBOARD_POLLS_addPoll"=>"Nouveau sondage",
			"DASHBOARD_POLLS_onlyVoted"=>"Sondages votés",
			"DASHBOARD_POLLS_onlyVotedInfo"=>"Afficher uniquement les sondages déjà voté",
			"DASHBOARD_POLLS_toVoteNb"=>"sondages à voter",
			"DASHBOARD_POLLS_voteSubmit"=>"Voter et voir les résultats",
			"DASHBOARD_POLLS_voteTooltip"=>"Le vote est anonyme : personne n'aura connaissance de votre choix",
			"DASHBOARD_POLLS_votesNb"=>"Voté --NB_VOTES-- fois",
			"DASHBOARD_POLLS_votesNbBis"=>"Le sondage a été voté --NB_VOTES-- fois",
			"DASHBOARD_POLLS_votedBy"=>"Voté par",
			"DASHBOARD_POLLS_noPolls"=>"Aucun sondage pour le moment",
			...
			"DASHBOARD_dateOfflineTooltip"=>"Programmer une date d'archivage automatique.",
			// Sondage/Polls
			"DASHBOARD_POLLS_titleQuestion"=>"Titre / Question",
			"DASHBOARD_POLLS_multipleResponses"=>"Plusieurs réponses possibles pour chaque vote",
			"DASHBOARD_POLLS_toVoteWithNews"=>"Afficher le formulaire de vote avec les actualités (menu de gauche)",
			"DASHBOARD_POLLS_publicVote"=>"Le choix de chaque votant est public",
			"DASHBOARD_POLLS_publicVoteInfo"=>"Le choix de chaque votant sera affiché dans le résultat du sondage.",
			"DASHBOARD_POLLS_dateEnd"=>"Fin des votes",
			"DASHBOARD_POLLS_responseList"=>"Responses possibles",
			"DASHBOARD_POLLS_responseNb"=>"Response n°",
			"DASHBOARD_POLLS_responseAdd"=>"Ajouter une réponse",
			"DASHBOARD_controlResponseNb"=>"Merci de spécifier au moins 2 réponses possibles",
			"DASHBOARD_POLLS_votedNotif"=>"Attention : dès que le sondage a commencé à être voté,<br> il n'est plus possible de modifier les propriétés du sondage",
			"DASHBOARD_POLLS_noResponseNotif"=>"Merci de sélectionner une réponse",
			"DASHBOARD_POLLS_exportPdf"=>"Télécharger le résultat du sondage en pdf",
			"DASHBOARD_POLLS_exportDate"=>"Résultat du sondage à la date du",

			////	MOD : FILE
			////
			"FILE_MODULE_NAME"=>"Fichiers",
			"FILE_MODULE_DESCRIPTION"=>"Gestionnaire de fichiers",
			"FILE_OPTION_adminRootAddContent"=>"Seul les administrateurs peuvent ajouter des dossiers et fichiers du dossier principal",
			"FILE_addFile"=>"Nouveau fichier",
			"FILE_folderAccessError"=>"Dossier inaccessible sur le serveur",
			...
			"CALENDAR_OPTION_adminAddRessourceCalendar"=>"Seul les administrateurs peuvent ajouter des agendas partagés",
			"CALENDAR_OPTION_adminAddCategory"=>"Seul les administrateurs peuvent éditer les categories d'événement",
			"CALENDAR_OPTION_createSpaceCalendar"=>"Créer un agenda partagé pour l'espace",
			"CALENDAR_CAT_menuTooltip"=>"Afficher uniquement les événements de la catégorie",
			...
			"CALENDAR_CAT_editTitle"=>"Editer les catégories",
			...
			"CALENDAR_yearWeekNum"=>"Afficher la semaine",
			"CALENDAR_periodNext"=>"Période suivante",
			"CALENDAR_periodPrev"=>"Période précédente",
			"CALENDAR_evtAffects"=>"Présent dans l'agenda",
			...
			"CALENDAR_evtEdit"=>"Modifier l'événement et ses affectations aux agendas",
			"CALENDAR_evtDelete"=>"Supprimer l'événement",
			"CALENDAR_evtRemoveFromCal"=>"Retirer l'événement de l'agenda",
			"CALENDAR_evtRemoveFromDate"=>"Retirer l'événement de cette date",
			...
			"CALENDAR_evtChangeTime"=>"Déplacer l'événement ?",
			...
			// Evenement
			"CALENDAR_importantEvent"=>"Événement important",
			...
			"CALENDAR_calendarAffectations"=>"Agendas où l’événement apparaît",
			...
			"CALENDAR_proposeEvtTooltipBis"=>"Option pour proposer l'événement :<br>L'événement devra être validé par le propriétaire de l'agenda",
			...
			"CALENDAR_propositionGuestTooltip"=>"Les invités peuvent proposer des événements si le droit d'accès ''Tous les utilisateurs et invités'' est en ''Ecriture'' ou ''Ecriture limité'' (cf menu ci-dessous)",
			...
			"FORUM_OPTION_adminAddSubject"=>"Seul les administrateurs peuvent ajouter de nouveaux sujets",
			"FORUM_OPTION_adminAddTheme"=>"Seul les administrateurs peuvent éditer les thèmes du forum",
			...
			"TASK_OPTION_adminRootAddContent"=>"Seul les administrateurs peuvent ajouter des dossiers et tâches du dossier principal",
			"TASK_OPTION_adminAddStatus"=>"Seul les administrateurs peuvent éditer des statuts de tâches",
			...
			"TASK_CAT_editTitle"=>"Editer les statuts",
			...
			"CONTACT_OPTION_adminRootAddContent"=>"Seul les administrateurs peuvent ajouter des dossiers et contacts du dossier principal",
			...
			"LINK_OPTION_adminRootAddContent"=>"Seul les administrateurs peuvent ajouter des dossiers et liens du dossier principal",
			...
			"MAIL_OPTION_onlyAdminAccess"=>"Seul les administrateurs peuvent envoyer des emails",
			...
			"MAIL_historyDelete"=>"Supprimer les anciens emails",
			"MAIL_historyDeleteXDays"=>"Envoyés depuis plus de --NB_DAYS-- jours",
			"MAIL_historyDeleteNotif"=>"Nombre d'emails supprimés",
