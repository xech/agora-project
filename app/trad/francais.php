...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"MAIL_elemCreatedBy"=>"--OBJLABEL-- créé par",
			"MAIL_elemModifiedBy"=>"--OBJLABEL-- modifié par",
			...
			"CALENDAR_proposeEvtTooltip"=>"Proposer un événement pour cet agenda (accessible en lecture) :<br> Validé ensuite par le propriétaire de l'agenda",
