...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"passwordInvalid"=>"Le mot de passe doit avoir au moins 8 caractères alphanumeriques : de préférence avec chiffres, lettres et caractères spéciaux",
			...
			"OBJ_calendarEvent"=>"évènement",
			"OBJ_calendarEvent_TO"=>"à l'évènement",
			"OBJ_calendarEvent_CONTENT"=>"les évènements",
			...
			"VISIO_launchFromEvent"=>"Lancer la visioconférence de l'évènement",
			...
			"INSTALL_dataDashboardNews"=>  '<h3>Bienvenue sur votre espace de partage &nbsp; <img src="app/img/logoSmall.png"></h3>
											...
											<h4><img src="app/img/calendar/iconSmall.png"> <a href="?ctrl=calendar">Créez des évènements sur l\'agenda partagé ou votre agenda personnel</a></h4>
			...
			"AGORA_logsTimeOut"=>"Conservation de l'historique des évènements",
			"AGORA_logsTimeOutTooltip"=>"La durée de conservation de l'historique des évènements concerne l'ajout ou la modif des éléments. Les logs de suppression sont conservés 1 an minimum.",
			...
			////	MOD : LOG
			////
			"LOG_MODULE_DESCRIPTION"=>"Historique des évènements",
			...
			"DASHBOARD_POLLS_onlyVoted"=>"Afficher les sondages votés",
			"DASHBOARD_POLLS_alreadyVoted"=>"sondages déjà voté",
			...
			"CALENDAR_OPTION_adminAddCategory"=>"Seul l'administrateur peut créer des categories d'évènement",
			"CALENDAR_OPTION_createSpaceCalendar"=>"Créer un agenda partagé pour l'espace",
			"CALENDAR_CAT_menuTooltip"=>"Afficher uniquement les évènements avec la catégorie",
			...
			"CALENDAR_CAT_editTitle"=>"Editer les catégories d'évènement",
			...
			"CALENDAR_exportIcal"=>"Exporter les évènements au format iCal",
			...
			"CALENDAR_importIcal"=>"Importer des évènements au format iCal",
			"CALENDAR_importIgnoreOldEvt"=>"Ne pas importer les évènements de plus d'un an",
			...
			"CALENDAR_evtProposition"=>"Proposition d'évènement à confirmer",
			"CALENDAR_evtProposedBy"=>"Proposé par",
			"CALENDAR_evtProposeConfirm"=>"Confirmer la proposition",
			"CALENDAR_evtProposeConfirmed"=>"La proposition d'évènement a bien été ajouté à l'agenda <br>Un email de notification a été envoyé à l'auteur",
			"CALENDAR_evtProposeConfirmedMail"=>"Votre proposition d'évènement a bien été confirmée par",
			...
			"CALENDAR_evtProposeDeclinedMail"=>"Votre proposition d'évènement a été déclinée",
			"CALENDAR_evtEdit"=>"Modifier l'évènement et ses affectations aux agendas",
			"CALENDAR_evtDelete"=>"Supprimer l'évènement",
			"CALENDAR_evtRemoveFromCal"=>"Retirer l'évènement de l'agenda",
			"CALENDAR_evtRemoveFromDate"=>"Retirer l'évènement de cette date",
			"CALENDAR_evtPrivate"=>"Évènement privé",
			"CALENDAR_evtAutor"=>"Évènements que j'ai créés",
			"CALENDAR_evtAutorInfo"=>"Afficher les évènements que j'ai créés",
			"CALENDAR_evtAutorSortCrea"=>"Trier par date de création (desc)",
			"CALENDAR_evtAutorSortBegin"=>"Trier par date de début de l'évènement (desc)",
			"CALENDAR_evtChangeTime"=>"Déplacer l'évènement ?",
			"CALENDAR_evtChangeTimeConfirmed"=>"L'évènement a bien été déplacé",
			"CALENDAR_noEvt"=>"Aucun évènement",
			...
			"CALENDAR_visibilityTooltip"=>"Pour les personnes n'ayant qu'un accès en lecture à l'agenda : <br>- Afficher la plage horaire : masque le détail de l'évènement mais affiche le créneau occupé<br>- Affichage privé : masque totalement l'évènement dans l'agenda",
			// Edit
			...
			"CALENDAR_calendarAffectations"=>"Évènement dans les agendas :",
			"CALENDAR_addEvt"=>"Nouvel évènement",
			"CALENDAR_addEvtTooltip"=>"Ajouter un évènement à l'agenda",
			"CALENDAR_addEvtTooltip2"=>"Ajouter l'évènement à l'agenda",
			"CALENDAR_proposeEvtTooltip"=>"Proposer l'évènement pour cet agenda (accessible en lecture seule) :<br>L'évènement devra être validé par le propriétaire de l'agenda",
