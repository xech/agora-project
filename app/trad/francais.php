...
class Trad extends Txt
{
	...
	public static function loadTradsLang()
	{
		...
		self::$trad=array(
			...
			"notifDeleteWait"=>"Merci de patienter un instant : la suppression du dossier peut prendre quelques secondes",
			...
			"HEADER_displayAdminInfo"=>"pour voir également les éléments qui ne me sont pas attribués (agendas, dossiers, etc)",
			...
			"MESSENGER_MODULE_DESCRIPTION"=>"Discutez ou lancez une visioconférence avec les personnes connectées à l'espace",
			"MESSENGER_messengerTitle"=>"Messagerie : cliquer sur le nom d'une personne pour discuter ou lancer une visioconférence",
			...
			"EDIT_attachedFileInsert"=>"Insérer dans l'éditeur",
			...
			"DASHBOARD_dateOnlineNotif"=>"Dans l'attente de sa publication automatique, l'actualité sera momentanément archivée",
			...
			"CALENDAR_period_monthBis"=>"Tous les --DATE-- du mois",
			"CALENDAR_period_year"=>"Tous les ans",
			"CALENDAR_period_yearBis"=>"Tous les --DATE-- de l'année",
