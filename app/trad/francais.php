...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"SPACE_publicSpaceRGPD"=>"Si votre espace public contient des données personnelles (téléphone, adresse...) pensez à spécifier un mot de passe pour être conforme à la RGPD",
			...
			"CALENDAR_calendarAffectations"=>"Agendas où l'événement est affiché",
