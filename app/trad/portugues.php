...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"copyUrlTooltip"=>"Permite o acesso externo ao elemento : a partir de uma notícia, de um email, de uma mensagem de fórum, de um blogue, etc.",
			...
			"resetPasswordNotif"=>"Você acabou de enviar um email para o seu endereço para restaurar sua senha. Se não recebeu um email, verifique se o endereço especificado está correto ou se o email não está na sua caixa de SPAM.",
			...
			"MAIL_addReplyToTooltip"=>"Adicione meu email no campo ''Responder a'' <br><span style='font-size:1.5em'>&#9888;</span> Com esta opção, seu email pode chegar como SPAM em alguns mensageiros",
			...
			"USER_searchPrecision"=>"Por favor, escolha um nome, sobrenome ou endereço de email",
