...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"passwordInvalid"=>"A senha deve conter pelo menos 8 caracteres alfanuméricos (idealmente com números, letras e caracteres especiais.)",
			...
			"userInscriptionNotif"=>"Notificar por email em cada registro",
