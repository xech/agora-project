...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"sendMailTo"=>"Enviar um email para",
			"mailInvalid"=>"Email não é válido",
			"element"=>"item",
			"elements"=>"itens",
			"folder"=>"pasta",
			"folders"=>"pastas",
			...
			"copyUrl"=>"Copiar o link de partilha",
			"copyUrlTooltip"=>"Copie o link de partilha (URL) para o enviar por e-mail, mensagem, etc.",
			"copyUrlNotif"=>"O link foi copiado com sucesso",
			"footerGeneratedTime"=>"Página gerada em",
			...
			"specifyLogin"=>"Por favor, informe um Email/Identificador (sem espaço)",
			"mailLloginNotif"=>"Recomenda-se usar um email como identificador de sessão",
			"mailLlogin"=>"Email / Login ID",
			"connect"=>"Entrar",
			...
			"connectSpaceSwitchInfo"=>"Alternar para um espaço de trabalho diferente de",
			...
			"password"=>"Senha",
			"passwordDisplay"=>"Mostrar / ocultar a senha",
			"passwordOptional"=>"Preencha este campo apenas para alterar a senha",
			"passwordInvalid"=>"A senha deve conter pelo menos 12 caracteres alfanuméricos (idealmente com números, letras e caracteres especiais.)",
			...
			"record"=>"Gravar",
			"modify"=>"Modificar",
			"modifyAndAccesRight"=>"Editar item e seus direitos de acesso",
			"validate"=>"Validar",
			"send"=>"Enviar",
			"sendTo"=>"Enviar para",
			...
			"objHistory"=>"Histórico do item",
			"all"=>"todos",
			"deletedUser"=>"Antiga conta de usuário",
			"categoryNotifSpaceAccess"=>"é acessível apenas no espaço",
			"categoryNotifChangeOrder"=>"A ordem de exibição foi alterada com sucesso",
			"folderContent"=>"Conteúdo",

			////	Droit d'accès d'un Objet
			"accessRead"=>"Leitura",
			"accessReadDetail"=>"Acesso somente leitura --OBJ_LABEL_TO--",
			"accessWriteLimit"=>"Escrita limitada",
			"accessWriteLimitDetail"=>"Acesso de leitura e <i>escrita limitada</i> --OBJ_LABEL_TO--:<br>Direito de adicionar, modificar e excluir somente --OBJ_LABEL_CONTENT-- que foram criados",
			"accessWrite"=>"Escrita",
			"accessWriteDetail"=>"Acesso de leitura e escrita --OBJ_LABEL_TO--",
			"accessWriteDetailContainer"=>"Acesso de leitura e escrita --OBJ_LABEL_TO--:<br>Direito de adicionar, modificar e excluir todos os --OBJ_LABEL_CONTENT--",
			"accessFullDetail"=>"Administrador e Autor:<br>Acesso completo de leitura e escrita --OBJ_LABEL_TO--",
			"accessAllUsers"=>"Todos os usuários",
			"accessAllUsersDetail"=>"Direitos de acesso para usuários do espaço <i>--SPACENAME--</i>",
			"accessAllUsersGuests"=>"Todos os usuários e convidados",
			"accessAllUsersGuestsDetail"=>"Direitos de acesso para usuários e convidados do espaço <i>--SPACENAME--</i>.<hr>Limitado a somente leitura para convidados (sem conta de usuário)",

			////	Libellé des objets (cf. "::objectType")
			"OBJ_space"=>"Espaço",								//ModSpace
			"OBJ_space_TO"=>"para o espaço",
			"OBJ_user"=>"usuário",								//ModUser
			"OBJ_user_TO"=>"ao usuário",
			"OBJ_mail"=>"email",								//ModMail
			"OBJ_mail_TO"=>"ao email",
			"OBJ_dashboardNews"=>"notícia",						//ModDashboard
			"OBJ_dashboardNews_TO"=>"à notícia",
			"OBJ_dashboardPoll"=>"enquete",
			"OBJ_dashboardPoll_TO"=>"à enquete",
			"OBJ_fileFolder"=>"pasta de arquivos",				//ModFile
			"OBJ_fileFolder_TO"=>"à pasta de arquivos",
			"OBJ_file"=>"arquivo",
			"OBJ_file_TO"=>"ao arquivo",
			"OBJ_file_CONTENT"=>"os arquivos",
			"OBJ_contactFolder"=>"pasta de contatos",			//ModContact
			"OBJ_contactFolder_TO"=>"à pasta de contatos",
			"OBJ_contact"=>"contato",
			"OBJ_contact_TO"=>"ao contato",
			"OBJ_contact_CONTENT"=>"os contatos",
			"OBJ_linkFolder"=>"pasta de favoritos",				//ModLink
			"OBJ_linkFolder_TO"=>"à pasta de favoritos",
			"OBJ_link"=>"favorito",
			"OBJ_link_TO"=>"ao favorito",
			"OBJ_link_CONTENT"=>"os favoritos",
			"OBJ_taskFolder"=>"pasta de tarefas",				//ModTask
			"OBJ_taskFolder_TO"=>"à pasta de tarefas",
			"OBJ_task"=>"tarefa",
			"OBJ_task_TO"=>"à tarefa",
			"OBJ_task_CONTENT"=>"as tarefas",
			"OBJ_calendar"=>"calendário",						//ModCalendar
			"OBJ_calendar_TO"=>"ao calendário",
			"OBJ_calendarEvent"=>"evento",
			"OBJ_calendarEvent_TO"=>"ao evento",
			"OBJ_calendarEvent_CONTENT"=>"os eventos",
			"OBJ_forumSubject"=>"tópico do fórum",				//ModForum
			"OBJ_forumSubject_TO"=>"ao tópico do fórum",
			"OBJ_forumMessage"=>"mensagem do fórum",
			"OBJ_forumMessage_TO"=>"à mensagem do fórum",
			"OBJ_forumMessage_CONTENT"=>"as mensagens do fórum",

			////	Envoi d'un email
			"MAIL_notifSendOk"=>"O email foi enviado com sucesso",
			"MAIL_notifSendOkBis"=>"O email de notificação foi enviado com sucesso",
			"MAIL_notifSendFail"=>"Não foi possível enviar o email",
			"MAIL_recipients"=>"Destinatários",
			"MAIL_recipientsTooltip"=>"Escolher os destinatários do email",
			"MAIL_hideRecipients"=>"Ocultar destinatários",
			"MAIL_hideRecipientsTooltip"=>"Coloque todos os destinatários em uma cópia oculta. Observe que, com esta opção, seu email pode chegar como SPAM em alguns mensageiros",
			"MAIL_addReplyTo"=>"Coloque meu email em resposta",
			"MAIL_addReplyToTooltip"=>"Adicione meu email no campo ''Responder a'' <br> Com esta opção, seu email pode chegar como SPAM em alguns mensageiros",
			...
			"MAIL_receptionNotifTooltip"=>"Aviso! Alguns clientes de email não oferecem suporte ao recibo de entrega",
			"MAIL_specificMails"=>"Adicionar endereços de email",
			"MAIL_specificMailsTooltip"=>"Adicionar endereços de email não listados no espaço",
			...
			"MAIL_maxFileSizeNotif"=>"O arquivo não foi adicionado ao email porque é muito grande",
			...
			"downloadBackToApp"=>"Voltar para a Omnispace",
			...
			"searchDateCrea_day"=>"menos de um dia",
			"searchDateCrea_week"=>"menos de uma semana",
			"searchDateCrea_month"=>"menos de um mês",
			"searchDateCrea_year"=>"menos de um ano",
			"advancedSearch"=>"Busca avançada",
			"advancedSearch_anyWord"=>"qualquer palavra",
			"advancedSearch_exactPhrase"=>"Frase exata",
			...
			"userInscriptionNotif"=>"Notificar os administradores por email a cada novo registro",
			"userInscriptionNotifTooltip"=>"Envie uma notificação por email aos administradores de espaço, após cada registro",
			...
			"export_vcard"=>"Exportar no formato vCard",
			...
			"NOTIF_fileNotAllowed"=>"arquivo não permitido. Os ficheiros sensíveis ou não reconhecidos devem ser comprimidos antes de serem adicionados",
			...
			////	Header
			"HEADER_spaceSwitch"=>"Exibir este espaço de trabalho",
			"HEADER_manageAllSpaces"=>"Administrar todos os espaços",
			"HEADER_displayAdmin"=>"Visualização de Administrador",
			"HEADER_displayAdminInfo"=>"Exibição do Administrador: Exibe todos os elementos presentes no espaço (agendas, pastas, etc.)",
			...
			"MESSENGER_visioProposeToUsers"=>"Iniciar a videoconferência entre",
			...
			"EDIT_showAllUsersInfo"=>"Exibir os utilizadores de todos os espaços de trabalho",
			"EDIT_showAllSpaces"=>"Mostre todos os espaços",
			"EDIT_notifMail"=>"Notificar",
			"EDIT_notifMail2"=>"Envie uma notificação de criação/alteração por email",
			"EDIT_notifMailTooltip"=>" Enviar uma notificação por e-mail para as pessoas com acesso --OBJ_LABEL_TO--",
			"EDIT_notifMailTooltipCal"=>"<hr>Calendário pessoal: enviado apenas para pessoas que podem editar o calendário.<br>Calendário compartilhado: enviado para qualquer pessoa que possa visualizar o calendário.",
			"EDIT_notifMailAddFiles"=>"Anexar arquivos à notificação",
			"EDIT_notifMailSelect"=>"Selecionar os destinatários das notificações",
			"EDIT_extendSubfolders"=>"Dar direitos iguais a todas as subpastas",
			"EDIT_extendSubfoldersTooltip"=>"Estender os direitos de acesso a subpastas que podem ser editadas",
			...
			"EDIT_guestMail"=>"Seu email",
			"EDIT_guestMailTooltip"=>"Especifique seu email para a validação de sua proposta",
			...
			"AGORA_nameTooltip"=>"Nome exibido na página de login, em emails, etc.",
			...
			"AGORA_userMailDisplay"=>"Endereços de email dos usuários visíveis para todos",
			"AGORA_userMailDisplayTooltip"=>"Mostrar/ocultar email no perfil de cada usuário, notificações por email, etc.<br>Observação: o administrador principal sempre poderá visualizar o email de cada usuário",
			...
			"AGORA_gOAuth"=>"Faça login através do meu endereço do Gmail",
			...
			"LOG_download"=>"Descarregue o ficheiro de histórico.",
			"LOG_path"=>"Caminho",
			"LOG_filterBy"=>"Filtro",
			"LOG_date"=>"Data",
			...
			////	MOD : SPACE
			////
			"SPACE_MODULE_NAME"=>"Espaços",
			"SPACE_moduleTooltip"=>"O espaço principal pode ser subdividido em vários espaços (consulte ''subespaço'')",
			"SPACE_config"=>"Gerenciar o espaço de trabalho",
			"SPACE_configInfo"=>"Gerenciar o espaço, seus módulos (ferramentas) e as atribuições aos usuários",
			"SPACE_space"=>"Espaço",
			...
			"SPACE_publicSpaceTooltip"=>"Um espaço público está aberto a pessoas que não têm uma conta de usuário (convidados). Eles podem acessar o espaço da página inicial. Você pode especificar uma senha para proteger o acesso a esse espaço público. Os módulos 'Emails' e 'Usuarios' não estão disponíveis para os convidados.",
			"SPACE_publicSpaceRGPD"=>"Seu espaço é público: se ele contiver dados pessoais (telefone, endereço etc.), lembre-se de especificar uma senha para cumprir a LGPD: Lei Geral de Proteção de Dados",
			"SPACE_usersInvitation"=>"Os usuários podem enviar convites por correio",
			"SPACE_usersInvitationTooltip"=>"Todos os usuários podem enviar email para participar do espaço",
			"SPACE_allUsers"=>"Todos os usuários",
			"SPACE_allUsersTooltip"=>"Atribuir todos os usuários ao espaço",
			"SPACE_user"=>"Usuários",
			"SPACE_userTooltip"=>"Usuário do espaço: <br> Acesso normal ao espaço",
			"SPACE_admin"=>"Administrador",
			"SPACE_adminTooltip"=>"O administrador de um espaço é um usuário que pode editar ou eliminar todos os itens presentes no espaço. Você também pode configurar o espaço, criar novas contas de usuário, criar grupos de usuários, enviar email para adicionar novos usuários, etc.",
			...
			"USER_sendCoordsTooltip"=>"Envie aos usuários um email com seu login e um link da web para inicializar sua senha",
			"USER_sendCoordsTooltip2"=>"Envie a cada novo usuário um email com informações de acesso.",
			...
			"USER_spaceNoAffectation"=>"O utilizador não está atribuído a nenhum espaço",
			...
			// Invitation
			"USER_sendInvitation"=>"Envie convites por email",
			"USER_sendInvitationTooltip"=>"Envie os convites por email para aderir ao espaço atual :<br> Assim que um convite é validado, é automaticamente criada uma conta de utilizador para a pessoa em questão",
			...
			"USER_allUsersOnSpace"=>"Todos os usuários estão atribuídos ao espaço",
			"USER_userAffectConfirm"=>"Confirmar as atribuições?",
			"USER_addExistUser"=>"Adicionar usuários existentes",
			"USER_addExistUserTitle"=>"Atribuir usuários existentes ao espaço",
			...
			"USER_loginExists"=>"O login/email já existe. Por favor, escolha outro!",
			"USER_mailPresentInAccount"=>"Já existe uma conta de usuário com este endereço de email",
			"USER_loginAndMailDifferent"=>"Ambos os endereços de email devem ser idênticos",
			...
			"USER_mailNotifContent3"=>"Por favor, guarde este email para seus registros.",
			...
			"DASHBOARD_offlineNews"=>"Notícias arquivadas",
			"DASHBOARD_offlineNewsInfo"=>"Mostrar apenas as notícias arquivadas",
			"DASHBOARD_noNews"=>"Não há notícias no momento",
			"DASHBOARD_POLLS_addPoll"=>"Adicionar uma pesquisa",
			"DASHBOARD_POLLS_onlyVoted"=>"Enquetes votadas",
			"DASHBOARD_POLLS_onlyVotedInfo"=>"Exibir apenas as enquetes já votadas",
			"DASHBOARD_POLLS_toVoteNb"=>"pesquisas não votadas",
			"DASHBOARD_POLLS_voteSubmit"=>"Vote e veja os resultados",
			"DASHBOARD_POLLS_voteTooltip"=>"Os votos são anônimos: ninguém saberá sua escolha de voto",
			"DASHBOARD_POLLS_votesNb"=>"Votada --NB_VOTES-- vezes",
			"DASHBOARD_POLLS_votesNbBis"=>"A pesquisa foi votada --NB_VOTES-- vezes",
			"DASHBOARD_POLLS_votedBy"=>"Votada por",
			"DASHBOARD_POLLS_noPolls"=>"Não há pesquisa no momento",
			...
			// Sondage/Polls
			"DASHBOARD_POLLS_titleQuestion"=>"Título / Pergunta",
			"DASHBOARD_POLLS_multipleResponses"=>"Várias respostas possíveis para cada voto",
			"DASHBOARD_POLLS_toVoteWithNews"=>"Mostrar com notícias (menu à esquerda)",
			"DASHBOARD_POLLS_publicVote"=>"Votação do público: a escolha dos eleitores é pública",
			"DASHBOARD_POLLS_publicVoteInfo"=>"Considere que a votação na modalidade pública pode ser uma barreira à participação na pesquisa.",
			"DASHBOARD_POLLS_dateEnd"=>"Fim das votações",
			"DASHBOARD_POLLS_responseList"=>"Possíveis respostas",
			"DASHBOARD_POLLS_responseNb"=>"Resposta n°",
			"DASHBOARD_POLLS_responseAdd"=>"Adicionar uma resposta",
			"DASHBOARD_controlResponseNb"=>"Por favor, especifique pelo menos 2 respostas possíveis",
			"DASHBOARD_POLLS_votedNotif"=>"Atenção: assim que a enquete for votada, não será mais possível alterar o título ou as respostas",
			"DASHBOARD_POLLS_noResponseNotif"=>"Por favor, selecione uma resposta",
			"DASHBOARD_POLLS_exportPdf"=>"Baixar os resultados da pesquisa em PDF",
			"DASHBOARD_POLLS_exportDate"=>"resultado da pesquisa para",
			...
			"FILE_folderAccessError"=>"Os diretórios do servidor não são acessíveis",
			...
			"FILE_uploadSimpleMultiple"=>"Seleção de um ou vários ficheiros",
			...
			"CALENDAR_importIgnoreOldEvt"=>"Não importe eventos com mais de um ano",
			"CALENDAR_importEvtPresent"=>"Já está presente",
  			"CALENDAR_importEvtPresentInfo"=>"Evento já presente no calendário ?",
			...
			"CALENDAR_yearWeekNum"=>"Ver a semana",
			"CALENDAR_periodNext"=>"Período seguinte",
			"CALENDAR_periodPrev"=>"Período anterior",
			"CALENDAR_evtAffects"=>"Presente no calendário",
			"CALENDAR_evtAffectToConfirm"=>"A confirmar no calendário",
			...
			"CALENDAR_evtEdit"=>"Editar evento e atribuições aos calendários",
			"CALENDAR_evtDelete"=>"Remover evento",
			"CALENDAR_evtRemoveFromCal"=>"Remover o evento do calendário",
			"CALENDAR_evtRemoveFromDate"=>"Remover o evento nesta data",
			...
			"CALENDAR_evtAutorSortCrea"=>"Classificar por data de criação (desc)",
			"CALENDAR_evtAutorSortBegin"=>"Classificar por data de início do evento (desc)",
			"CALENDAR_evtChangeTime"=>"Mover o evento ?",
			...
			// Evenement
			"CALENDAR_importantEvent"=>"Evento importante",
			...
			"CALENDAR_calendarAffectations"=>"Calendários onde o evento é exibido",
			...
			"CALENDAR_proposeEvtTooltip"=>"Propor um evento para este calendário de leitura acessível : depois confirmado pelo proprietário do calendário",
			"CALENDAR_proposeEvtTooltipBis"=>"Opção de propor o evento : depois confirmado pelo proprietário do calendário",
			...
			"CALENDAR_propositionNotif"=>"Notificar por email de cada proposta de evento",
			...
			"CALENDAR_propositionEmailSubject"=>"Novo evento proposto por",
			"CALENDAR_propositionEmailMessage"=>"Novo evento proposto por --AUTOR_LABEL-- : &nbsp; <i><b>--EVT_TITLE_DATE--</b></i> <br><i>--EVT_DESCRIPTION--</i> <br>Acesse seu espaço para confirmar ou cancelar esta proposta",
			...
			"FORUM_notifyLastPostTooltip"=>"Quero receber uma notificação por email para cada nova mensagem",
			...
			"TASK_folderDateBegin"=>"Data de início mais antiga",
			"TASK_folderDateEnd"=>"Data última data de término",
			...
			"MAIL_MODULE_DESCRIPTION"=>"Enviar mensagens de email com um único clique!",
			"MAIL_OPTION_onlyAdminAccess"=>"Apenas os administradores podem acessar o módulo e enviar emails",
			"MAIL_specifyMail"=>"Por favor, especificar ao menos um destinatário",
			"MAIL_title"=>"Assunto do email",
			"MAIL_description"=>"Mensagem de email",
			"MAIL_historyTitle"=>"Histórico dos emails enviados",
			"MAIL_historyDelete"=>"Excluir emails antigos",
			"MAIL_historyDeleteXDays"=>"Enviados há pelo menos --NB_DAYS-- dias",
			"MAIL_historyDeleteNotif"=>"Número de emails excluídos",
			"MAIL_delete"=>"Excluir este email",
			"MAIL_resend"=>"Reenviar este email",
			"MAIL_resendInfo"=>"Recuperar o conteúdo deste email e integrá-lo diretamente ao editor para um novo envio",
			"MAIL_historyEmpty"=>"Sem email",
		);
	}
