...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"resetPassword2"=>"Informe seu e-mail para redefinir sua senha de acesso",
			"resetPasswordNotif"=>"O e-mail para redefinir sua senha foi enviado.<br>Se não o recebeu, verifique o endereço informado",
			...
			////	Envoi d'un email
			"MAIL_sendOk"=>"O email foi enviado com sucesso",
			"MAIL_sendNotOk"=>"Não foi possível enviar o email...",
			...
			"MAIL_sendNotif"=>"O email de notificação foi enviado!",
