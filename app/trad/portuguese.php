...
class Trad extends Txt
{
	...
	public static function loadTradsLang()
	{
		...
		setlocale(LC_TIME, "pt_BR.utf8", "pt_BR.UTF-8", "pt_BR", "br", "portuguese");
		...
		self::$trad=array(
			...
			"copyUrl"=>"Copiar o link/url para o item",
			"copyUrlTooltip"=>"Este link/URL permite o acesso direto ao item: <br> pode ser integrado a uma notícia, um tópico do fórum, um e-mail, um blog (acesso externo) etc.",
			...
			"MAIL_sendOk"=>"O e-mail foi enviado!",
			"MAIL_sendNotif"=>"O e-mail de notificação foi enviado!",
			"MAIL_notSend"=>"O e-mail não pôde ser enviado",
			"MAIL_notSendEverybody"=>"O e-mail não foi enviado a todos os destinatários: se possível, verifique a validade dos e-mails",
			...
			"AGORA_confirmModif"=>"Confirmar as mudanças?",
			"AGORA_name"=>"Nome do site",
			"AGORA_footerHtml"=>"Footer / Rodapé de página texto/html",
			"AGORA_lang"=>"Idioma padrão",
			"AGORA_timezone"=>"Fuso horário",
			"AGORA_spaceName"=>"Nome do espaço principal",
			"AGORA_diskSpaceLimit"=>"Disco disponível para arquivos",
			"AGORA_logsTimeOut"=>"Duração do histórico de eventos (registros)",
			"AGORA_logsTimeOutTooltip"=>"O período de retenção do histórico de eventos refere-se à adição ou modificação dos itens. Os registros de exclusão são mantidos por pelo menos 1 ano.",
			"AGORA_visioHost"=>"Servidor de videoconferência Jitsi",
			"AGORA_visioHostTooltip"=>"Caminho do servidor de videoconferência Jitsi. Exemplo: https://meet.jit.si",
			"AGORA_visioHostAlt"=>"Servidor alternativo de videoconferência",
			"AGORA_visioHostAltTooltip"=>"Servidor alternativo de videoconferência: em caso de indispensabilidade do servidor de vídeo principal",
			"AGORA_skin"=>"Cor da interface",
			"AGORA_black"=>"Escura",
			"AGORA_white"=>"Branca",
			"AGORA_wallpaperLogoError"=>"A imagem e o logotipo do plano de fundo devem ter o formato JPG ou PNG",
			"AGORA_deleteWallpaper"=>"Remover a imagem de fundo",
			"AGORA_logo"=>"Logotipo no rodapé da página",
			"AGORA_logoUrl"=>"URL",
			"AGORA_logoConnect"=>"logo / imagem da página de conexão",
			"AGORA_logoConnectTooltip"=>"Exibido no formulário de conexão",
			"AGORA_usersCommentLabel"=>"Permita que os usuários comentem sobre o item",
			"AGORA_usersComment"=>"comentário",
			"AGORA_usersComments"=>"comentários",
			"AGORA_usersLikeLabel"=>"Os usuários podem <i>Curtir</i> o item",
			"AGORA_usersLike_likeSimple"=>"Apenas Curtir",
			"AGORA_usersLike_likeOrNot"=>"Curtir / Não curtir",
			"AGORA_usersLike_like"=>"Curtir",
			"AGORA_usersLike_dontlike"=>"Não curtir",
			"AGORA_mapTool"=>"Ferramenta de mapeamento",
			"AGORA_mapToolTooltip"=>"Ferramenta de mapeamento para ver usuários e contatos em um mapa",
			"AGORA_mapApiKey"=>"'API Key' para ferramenta de mapeamento",
			"AGORA_mapApiKeyTooltip"=>"API Key para a ferramenta de mapeamento do Google Maps: <br>https://developers.google.com/maps/ <br>https://developers.google.com/maps/documentation/javascript/get-api-key",
			"AGORA_gIdentity"=>"Conexão opcional do Google",
			"AGORA_gIdentityTooltip"=>"Os usuários podem se conectar mais facilmente ao seu espaço através da conta do Google: para isso, um e-mail <i>@gmail.com</ i> já deve ser registrado na conta de usuário",
			"AGORA_gIdentityClientId"=>"Configuração de Sign-In : Client ID",
			"AGORA_gIdentityClientIdTooltip"=>"Esta configuração é necessária para Google Sign-In : https://developers.google.com/identity/sign-in/web/",
			"AGORA_gPeopleApiKey"=>"Configurações do Google People: API KEY",
			"AGORA_gPeopleApiKeyTooltip"=>"Esta configuração é necessária para recuperar contatos de Google / Gmail : <a href='https://developers.google.com/people/' target='_blank'>https://developers.google.com/people/</a>",
			"AGORA_messengerDisabled"=>"Mensagens instantâneas ativadas",
			"AGORA_moduleLabelDisplay"=>"Nome dos módulos na barra de menus",
			"AGORA_folderDisplayMode"=>"Visualização em pastas",
			"AGORA_personsSort"=>"Ordenar usuários e contatos",
			//SMTP
			...
			"CALENDAR_icalUrl"=>"Copie o link/url para visualizar o calendário no aplicativo externo",
			"CALENDAR_icalUrlCopy"=>"Permite a leitura de eventos do calendário em formato iCal, através de um aplicativo externo como Microsoft Outlook, Google Calendar, Mozilla Thunderbird, etc.",
			...
			"CALENDAR_evtAutor2"=>"Mostrar somente os eventos que criei",
			...
			"MAIL_attachedFileError"=>"O arquivo não foi adicionado ao e-mail porque é muito grande",
		);
	}
	...
	public static function celebrationDays($year)
	{
		...
		$dateList[$year."-01-01"]="Confraternização Universal";
		$dateList[$year."-04-21"]="Tiradentes";
		$dateList[$year."-05-01"]="Dia do Trabalhador";
		$dateList[$year."-09-07"]="Independência do Brasil";
		$dateList[$year."-10-12"]="Nossa Senhora Aparecida";
		$dateList[$year."-11-02"]="Finados";
