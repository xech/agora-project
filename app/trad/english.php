...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"connectSpaceSwitchInfo"=>"Switch to a workspace other than",
			...
			"password"=>"Password",
			"passwordDisplay"=>"Show / hide password",
			"passwordOptional"=>"Fill in this field only to change the password",
			"passwordInvalid"=>"The password must contain at least 12 alphanumeric characters (ideally with numbers, letters and special characters)",
			...
			"record"=>"Record",
			"modify"=>"Modify",
			"modifyAndAccesRight"=>"Edit item and its access rights",
			"validate"=>"Validate",
			"send"=>"Send",
			"sendTo"=>"Send to",
			...
			"modifBy"=>"Modified by",
			"objHistory"=>"Item history",
			"all"=>"all",
			"deletedUser"=>"Former user account",
			"categoryNotifSpaceAccess"=>"is only accessible on the space",
			"categoryNotifChangeOrder"=>"The display order has been successfully changed",
			...
			"OBJ_space_TO"=>"to the space",
			"OBJ_user"=>"user",									//ModUser
			"OBJ_user_TO"=>"to the user",
			"OBJ_mail"=>"email",								//ModMail
			"OBJ_mail_TO"=>"to the email",
			"OBJ_dashboardNews"=>"news",						//ModDashboard
			"OBJ_dashboardNews_TO"=>"to the news",
			"OBJ_dashboardPoll"=>"poll",
			"OBJ_dashboardPoll_TO"=>"to the poll",
			"OBJ_fileFolder"=>"file folder",  					//ModFile
			"OBJ_fileFolder_TO"=>"to the file folder",
			"OBJ_file"=>"file",
			"OBJ_file_TO"=>"to the file",
			"OBJ_file_CONTENT"=>"the files",
			"OBJ_contactFolder"=>"contact folder",    			//ModContact
			"OBJ_contactFolder_TO"=>"to the contact folder",
			"OBJ_contact"=>"contact",
			"OBJ_contact_TO"=>"to the contact",
			"OBJ_contact_CONTENT"=>"the contacts",
			"OBJ_linkFolder"=>"favorites folder",      			//ModLink
			"OBJ_linkFolder_TO"=>"to the favorites folder",
			"OBJ_link"=>"favorite",
			"OBJ_link_TO"=>"to the favorite",
			"OBJ_link_CONTENT"=>"the favorites",
			"OBJ_taskFolder"=>"task folder",					//ModTask
			"OBJ_taskFolder_TO"=>"to the task folder",
			"OBJ_task"=>"task",
			"OBJ_task_TO"=>"to the task",
			"OBJ_task_CONTENT"=>"the tasks",
			"OBJ_calendar"=>"calendar",							//ModCalendar
			"OBJ_calendar_TO"=>"to the calendar",
			"OBJ_calendarEvent"=>"event",
			"OBJ_calendarEvent_TO"=>"to the event",
			"OBJ_calendarEvent_CONTENT"=>"the events",
			"OBJ_forumSubject"=>"forum topic",					//ModForum
			"OBJ_forumSubject_TO"=>"to the forum topic",
			"OBJ_forumMessage"=>"forum message",
			"OBJ_forumMessage_TO"=>"to the forum message",
			"OBJ_forumMessage_CONTENT"=>"the forum messages",
			
			////	Envoi d'un email
			"MAIL_notifSendOk"=>"The email was sent successfully",
			"MAIL_notifSendOkBis"=>"The notification email was sent successfully",
			"MAIL_notifSendFail"=>"The email could not be sent",
			"MAIL_recipients"=>"Recipients",
			"MAIL_recipientsTooltip"=>"Choose email recipients",
			...
			"MAIL_addReplyToTooltip"=>"Add my email in the ''Reply to'' field <br> Note that with this option your email may arrive in spam in some mailboxes",
			...
			"downloadBackToApp"=>"Back to Omnispace",
			...
			"userInscriptionNotif"=>"Notify administrators by email for each new registration",
			...
			"exportFormat"=>"Format",
			"export_vcard"=>"Export as vCard format",
			...
			"NOTIF_fileNotAllowed"=>"sensitive or unrecognized files must be zipped before being added",
			...
			////	Header
			"HEADER_spaceSwitch"=>"Display this workspace",
			"HEADER_manageAllSpaces"=>"Manage all spaces",
			...
			"EDIT_showAllUsersInfo"=>"Display users from all workspaces",
			...
			"EDIT_extendSubfoldersTooltip"=>"Extend rights of access, to subfolders that you can edit",
			...
			"AGORA_gOAuth"=>"Login with my Gmail address",
			...
			"LOG_download"=>"Download the history file",
			"LOG_path"=>"Path",
			"LOG_filterBy"=>"Filter by",
			"LOG_date"=>"Date",
			...
			////	MOD : SPACE
			////
			"SPACE_MODULE_NAME"=>"Spaces",
			"SPACE_moduleTooltip"=>"The main space can be subdivided into several spaces (see ''subspace'')",
			"SPACE_config"=>"Manage workspace",
			"SPACE_configInfo"=>"Manage the workspace, its modules (tools) and user assignments",
			"SPACE_space"=>"space",
			"SPACE_spaces"=>"spaces",
			...
			"SPACE_publicSpaceRGPD"=>"Your space is public: if it contains personal data (telephone, address, etc.) remember to specify a password to comply with the GDPR : General Data Protection Regulation",
			...
			"SPACE_allUsersTooltip"=>"Assign all users to the space",
			"SPACE_user"=>" User",
			...
			"USER_spaceNoAffectation"=>"The user is not assigned to any space",
			...
			"USER_allUsersOnSpace"=>"All users are assigned to the space",
			...
			"USER_livecounterVisibility"=>"Presence on messaging",
			...
			"DASHBOARD_offlineNews"=>"Archived news",
			"DASHBOARD_offlineNewsInfo"=>"Show only archived news",
			"DASHBOARD_noNews"=>"No news for the moment",
			"DASHBOARD_POLLS_addPoll"=>"Add a poll",
			"DASHBOARD_POLLS_onlyVoted"=>"Voted polls",
			"DASHBOARD_POLLS_onlyVotedInfo"=>"Show only already voted polls",
			"DASHBOARD_POLLS_toVoteNb"=>"unvoted polls",
			"DASHBOARD_POLLS_voteSubmit"=>"Vote and see the results !",
			"DASHBOARD_POLLS_voteTooltip"=>"The votes are anonymous : nobody will know your choice of vote",
			"DASHBOARD_POLLS_votesNb"=>"Voté --NB_VOTES-- times",
			"DASHBOARD_POLLS_votesNbBis"=>"The poll was voted --NB_VOTES-- times",
			"DASHBOARD_POLLS_votedBy"=>"Voted by",
			"DASHBOARD_POLLS_noPolls"=>"No poll for the moment",
			...
			// Sondage/Polls
			"DASHBOARD_POLLS_titleQuestion"=>"Title / Question",
			"DASHBOARD_POLLS_multipleResponses"=>"Several answers possible for each vote",
			"DASHBOARD_POLLS_toVoteWithNews"=>"Show with news (left menu)",
			"DASHBOARD_POLLS_publicVote"=>"Public vote: the choice of voters is  public",
			"DASHBOARD_POLLS_publicVoteInfo"=>"Note that a public vote can be a barrier to participation to the survey.",
			"DASHBOARD_POLLS_dateEnd"=>"End of votes",
			"DASHBOARD_POLLS_responseList"=>"Possible answers",
			"DASHBOARD_POLLS_responseNb"=>"Answer n°",
			"DASHBOARD_POLLS_responseAdd"=>"Add an answer",
			"DASHBOARD_controlResponseNb"=>"Please specify at least 2 possible answers",
			"DASHBOARD_POLLS_votedNotif"=>"Attention: as soon as the poll is voted, it is no longer possible to change the title or the answers",
			"DASHBOARD_POLLS_noResponseNotif"=>"Please select an answer",
			"DASHBOARD_POLLS_exportPdf"=>"Download the survey results in pdf",
			"DASHBOARD_POLLS_exportDate"=>"survey result as of",
			...
			"FILE_folderAccessError"=>"Folder on the server not accessible",
			...
			"FILE_uploadSimpleMultiple"=>"Single or multiple file selection",
			...
			"CALENDAR_importIgnoreOldEvt"=>"Do not import events older than one year",
			"CALENDAR_importEvtPresent"=>"Already present",
			"CALENDAR_importEvtPresentInfo"=>"Event already present in the calendar ?",
			...
			"CALENDAR_yearWeekNum"=>"Display the week",
			"CALENDAR_periodNext"=>"Next period",
			"CALENDAR_periodPrev"=>"Preceding period",
			"CALENDAR_evtAffects"=>"Present in the calendar",
			"CALENDAR_evtAffectToConfirm"=>"To be confirmed in the calendar",
			...
			"CALENDAR_evtEdit"=>"Edit event and assignments to calendars",
			"CALENDAR_evtDelete"=>"Delete event",
			"CALENDAR_evtRemoveFromCal"=>"Remove the event from the calendar",
			"CALENDAR_evtRemoveFromDate"=>"Remove the event from this date",
			...
			"CALENDAR_evtAutorSortCrea"=>"Sort by creation date (desc)",
			"CALENDAR_evtAutorSortBegin"=>"Sort by event start date (desc)",
			"CALENDAR_evtChangeTime"=>"Move the event?",
			...
			// Evenement
			"CALENDAR_importantEvent"=>"Important event",
			...
			"CALENDAR_calendarAffectations"=>"Calendars where the event is displayed",
			...
			"CALENDAR_proposeEvtTooltipBis"=>"Option to propose the event : Then validated by the calendar's owner",
			...
			"MAIL_OPTION_onlyAdminAccess"=>"Only administrators can access the module and send emails",
			...
			"MAIL_historyDelete"=>"Delete old emails",
			"MAIL_historyDeleteXDays"=>"Sent at least --NB_DAYS-- days ago",
			"MAIL_historyDeleteNotif"=>"Number of emails deleted",
