...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"resetPassword2"=>"Enter your email address to reset your login password",
			"resetPasswordNotif"=>"An email has just been sent to reset your password.<br>If you haven't received it, please check your email address",
