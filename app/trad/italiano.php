...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"resetPassword2"=>"Inserisci il tuo indirizzo email per reimpostare la password di accesso",
			"resetPasswordNotif"=>"L'email per reimpostare la password è stata inviata.<br>Se non l'hai ricevuta, verifica l'indirizzo inserito",
			...
			////	Envoi d'un email
			"MAIL_sendOk"=>"L'email è stata inviata con successo",
			"MAIL_sendNotOk"=>"Impossibile inviare l'email",
			...
			"MAIL_sendNotif"=>"L'email di notifica è stata inviata",
