...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"copyUrlTooltip"=>"L'indirizzo di condivisione (URL) consente l'accesso esterno da un'email, un blog, ecc.",
			...
			"resetPassword2"=>"Inserisci il tuo indirizzo email per ricevere login e password",
			"resetPasswordNotif"=>"È stata appena inviata un email al vostro indirizzo per reimpostare la password. Se non avete ricevuto l'email, verificate che l'indirizzo specificato sia corretto o che l'email non sia presente nello spam",
			...
			"MAIL_addReplyToTooltip"=>"Aggiungi il mio messaggio di posta elettronica nel campo ''Rispondi a'' <br><span style='font-size:1.5em'>&#9888;</span> Si noti che con questa opzione l'email potrebbe finire nello spam in alcune caselle di posta elettronica",
			...
			"USER_searchPrecision"=>"Grazie per aver specificato un cognome, un nome o un indirizzo email",
