...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"sendMail"=>"Invia un email",
			"sendMailTo"=>"Invia un email a",
			"mailInvalid"=>"Questa email non è valida",
			"element"=>"elemento",
			"elements"=>"elementi",
			"folder"=>"cartella",
			"folders"=>"cartelle",
			...
			"confirmDeleteWait"=>"Attendi un attimo: la cancellazione della cartella potrebbe richiedere alcuni secondi",
			...
			"specifyLogin"=>"Grazie per aver scelto un email/login (senza spazi)",
			"mailLloginNotif"=>"Si consiglia di utilizzare un email come ID di accesso",
			...
			"connectSpaceSwitchInfo"=>"Passa a uno spazio di lavoro diverso da",
			...
			"password"=>"Password",
			"passwordDisplay"=>"Mostra / nascondi la password",
			"passwordOptional"=>"Compila questo campo solo per modificare la password",
			"passwordInvalid"=>"La password deve contenere almeno 12 caratteri alfanumerici (idealmente con numeri, lettere e caratteri speciali)",
			...
			"record"=>"Salva",
			"modify"=>"Modifica",
			"modifyAndAccesRight"=>"Modifica elemento e i suoi diritti di accesso",
			"validate"=>"Convalida",
			"send"=>"Invia",
			"sendTo"=>"Invia a",
			...
			"objHistory"=>"Cronologia dell'elemento",
			"all"=>"tutti",
			"deletedUser"=>"Vecchio account utente",
			"categoryNotifSpaceAccess"=>"è accessibile solo nello spazio",
			"categoryNotifChangeOrder"=>"L'ordine di visualizzazione è stato modificato correttamente",
			"folderContent"=>"Contenuto",

			////	Droit d'accès d'un Objet
			"accessRead"=>"Lettura",
			"accessReadDetail"=>"Accesso in sola lettura --OBJ_LABEL_TO--",
			"accessWriteLimit"=>"Scrittura limitata",
			"accessWriteLimitDetail"=>"Accesso in lettura e <i>scrittura limitata</i> --OBJ_LABEL_TO-- :<br>Diritto di aggiungere, modificare ed eliminare solo --OBJ_LABEL_CONTENT-- che si sono creati",
			"accessWrite"=>"Scrittura",
			"accessWriteDetail"=>"Accesso in lettura e scrittura --OBJ_LABEL_TO--",
			"accessWriteDetailContainer"=>"Accesso in lettura e scrittura --OBJ_LABEL_TO-- :<br>Diritto di aggiungere, modificare ed eliminare tutti i --OBJ_LABEL_CONTENT--",
			"accessFullDetail"=>"Amministratore e Autore:<br>Accesso completo in lettura e scrittura --OBJ_LABEL_TO--",
			"accessAllUsers"=>"Tutti gli utenti",
			"accessAllUsersDetail"=>"Diritti di accesso per gli utenti dello spazio <i>--SPACENAME--</i>",
			"accessAllUsersGuests"=>"Tutti gli utenti e ospiti",
			"accessAllUsersGuestsDetail"=>"Diritti di accesso per utenti e ospiti dello spazio <i>--SPACENAME--</i>.<hr>Limitato a sola lettura per gli ospiti (senza account utente)",

			////	Libellé des objets (cf. "::objectType")
			"OBJ_space"=>"Spazio",								//ModSpace
			"OBJ_space_TO"=>"allo spazio",
			"OBJ_user"=>"utente",								//ModUser
			"OBJ_user_TO"=>"all'utente",
			"OBJ_mail"=>"email",								//ModMail
			"OBJ_mail_TO"=>"all'email",
			"OBJ_dashboardNews"=>"notizia",						//ModDashboard
			"OBJ_dashboardNews_TO"=>"alla notizia",
			"OBJ_dashboardPoll"=>"sondaggio",
			"OBJ_dashboardPoll_TO"=>"al sondaggio",
			"OBJ_fileFolder"=>"cartella file",					//ModFile
			"OBJ_fileFolder_TO"=>"alla cartella file",
			"OBJ_file"=>"file",
			"OBJ_file_TO"=>"al file",
			"OBJ_file_CONTENT"=>"i file",
			"OBJ_contactFolder"=>"cartella contatti",			//ModContact
			"OBJ_contactFolder_TO"=>"alla cartella contatti",
			"OBJ_contact"=>"contatto",
			"OBJ_contact_TO"=>"al contatto",
			"OBJ_contact_CONTENT"=>"i contatti",
			"OBJ_linkFolder"=>"cartella preferiti",				//ModLink
			"OBJ_linkFolder_TO"=>"alla cartella preferiti",
			"OBJ_link"=>"preferito",
			"OBJ_link_TO"=>"al preferito",
			"OBJ_link_CONTENT"=>"i preferiti",
			"OBJ_taskFolder"=>"cartella attività",				//ModTask
			"OBJ_taskFolder_TO"=>"alla cartella attività",
			"OBJ_task"=>"attività",
			"OBJ_task_TO"=>"all'attività",
			"OBJ_task_CONTENT"=>"le attività",
			"OBJ_calendar"=>"calendario",						//ModCalendar
			"OBJ_calendar_TO"=>"al calendario",
			"OBJ_calendarEvent"=>"evento",
			"OBJ_calendarEvent_TO"=>"all'evento",
			"OBJ_calendarEvent_CONTENT"=>"gli eventi",
			"OBJ_forumSubject"=>"argomento del forum",			//ModForum
			"OBJ_forumSubject_TO"=>"all'argomento del forum",
			"OBJ_forumMessage"=>"messaggio del forum",
			"OBJ_forumMessage_TO"=>"al messaggio del forum",
			"OBJ_forumMessage_CONTENT"=>"i messaggi del forum",

			////	Envoi d'un email
			"MAIL_notifSendOk"=>"L'email è stata inviate correttamente",
			"MAIL_notifSendOkBis"=>"L'email di notifica è stata inviate correttamente",
			"MAIL_notifSendFail"=>"Non è stato possibile inviare l'email",
			"MAIL_recipients"=>"Destinatari",
			"MAIL_recipientsTooltip"=>"Scegli i destinatari dell'email",
			"MAIL_hideRecipients"=>"Nascondi destinatari",
			"MAIL_hideRecipientsTooltip"=>"Metti tutti i destinatari in copia nascosta. Si noti che con questa opzione l'email potrebbe arrivare nello spam in alcune caselle di posta elettronica",
			"MAIL_addReplyTo"=>"Metti il mio messaggio di posta elettronica in risposta",
			"MAIL_addReplyToTooltip"=>"Aggiungi il mio messaggio di posta elettronica nel campo ''Rispondi a'' <br> Si noti che con questa opzione l'email potrebbe finire nello spam in alcune caselle di posta elettronica",
			...
			"MAIL_maxFileSizeNotif"=>"Il file non è stato aggiunto all'email perché è troppo grande",
			...
			"downloadBackToApp"=>"Torna all'app Omnispace",
			...
			"searchDateCrea_day"=>"meno di un giorno",
			"searchDateCrea_week"=>"meno di una settimana",
			"searchDateCrea_month"=>"meno di un mese",
			"searchDateCrea_year"=>"meno di un anno",
			"advancedSearch"=>"Ricerca avanzata",
			"advancedSearch_anyWord"=>"qualsiasi parola",
			"advancedSearch_exactPhrase"=>"frase esatta",
			...
			"userInscriptionNotif"=>"Notificare agli amministratori via email ogni nuova iscrizione",
			"userInscriptionNotifTooltip"=>"Invia una notifica via email agli amministratori dello spazio, dopo ogni registrazione",
			...
			"export_vcard"=>"Esporta in formato vCard",
			...
			"NOTIF_fileNotAllowed"=>"file non consentito. I file sensibili o non riconosciuti devono essere compressi prima di essere aggiunti",
			...
			////	Header
			"HEADER_spaceSwitch"=>"Mostra questo spazio di lavoro",
			"HEADER_manageAllSpaces"=>"Gestione di tutti gli spazi",
			...
			"EDIT_showAllUsersInfo"=>"Mostra gli utenti di tutti gli spazi di lavoro",
			...
			"EDIT_extendSubfoldersTooltip"=>"Estendi i diritti di accesso alle sottocartelle che puoi modificare",
			...
			"EDIT_guestMail"=>"Il tuo indirizzo email",
			"EDIT_guestMailTooltip"=>"Specificare l'email per la convalida della proposta",
			...
			"AGORA_nameTooltip"=>"Nome visualizzato nella pagina di accesso, nelle email, ecc.",
			...
			"AGORA_logsTimeOutTooltip"=>"Il periodo di conservazione della cronologia degli eventi riguarda l'aggiunta o la modifica di elementi. I registri di la cancellazione vengono conservati per un minimo di 1 anno.",
			...
			"AGORA_userMailDisplayTooltip"=>"Mostra/nascondi l'email nel profilo di ciascun utente, notifiche email, ecc.<br>Nota: l'amministratore principale sarà sempre in grado di visualizzare l'email di ciascun utente",
			...
			"AGORA_gOAuth"=>"Accedi tramite il mio indirizzo Gmail",
			...
			"LOG_download"=>"Scarica il file storico",
			"LOG_path"=>"Percorso",
			"LOG_filterBy"=>"Filtro",
			"LOG_date"=>"Data",
			...
			////	MOD : SPACE
			////
			"SPACE_MODULE_NAME"=>"Spazi",
			"SPACE_moduleTooltip"=>"Lo spazio principale può essere suddiviso in più spazi (vedere 'sottospazio')",
			"SPACE_config"=>"Gestire lo spazio di lavoro",
			"SPACE_configInfo"=>"Gestire lo spazio, i suoi moduli (strumenti) e le assegnazioni agli utenti",
			"SPACE_space"=>"spazio",
			"SPACE_spaces"=>"spazi",
			...
			"SPACE_publicSpaceRGPD"=>"Il vostro spazio è pubblico: se contiene dati personali (telefono, indirizzo, ecc.) ricordatevi di specificare una password per rispettare il GDPR: General Data Protection Regulation",
			"SPACE_usersInvitation"=>"Gli utenti possono inviare inviti via email",
			"SPACE_usersInvitationTooltip"=>"Tutti gli utenti possono inviare inviti via email per unirsi allo spazio",
			"SPACE_allUsers"=>"Tutti gli utenti",
			"SPACE_allUsersTooltip"=>"Assegna tutti gli utenti allo spazio",
			"SPACE_user"=>" Utente",
			"SPACE_userTooltip"=>"Utente dello spazio: <br> Accesso normale allo spazio",
			"SPACE_admin"=>"Amministratore",
			"SPACE_adminTooltip"=>"L'amministratore di uno spazio è un utente che può modificare o eliminare tutti gli elementi presenti nello spazio. Può inoltre configurare lo spazio, creare nuovi account utente, creare gruppi di utenti, inviare inviti via email per aggiungere nuovi utenti, ecc,",
			...
			"USER_sendCoordsTooltip"=>"Invia agli utenti un email con il login e un link per inizializzare la password",
			"USER_sendCoordsTooltip2"=>"Invia agli utenti un email con le informazioni di accesso",
			...
			"USER_spaceNoAffectation"=>"L'utente non è assegnato a nessun spazio",
			...
			// Invitations
			"USER_sendInvitation"=>"Invia inviti via email",
			...
			"USER_allUsersOnSpace"=>"Tutti gli utenti sono assegnati allo spazio",
			"USER_userAffectConfirm"=>"Confermare le assegnazioni?",
			"USER_addExistUser"=>"Aggiungi utenti esistenti",
			"USER_addExistUserTitle"=>"Assegna utenti esistenti allo spazio",
			"USER_submitSearch"=>"Ricerca",
			// Utilisateur_edit & CO
			"USER_langs"=>"Lingua",
			...
			"USER_mailPresentInAccount"=>"Esiste già un account utente con questo indirizzo email",
			"USER_loginAndMailDifferent"=>"Entrambi gli indirizzi email devono essere identici",
			...
			"USER_mailNotifContent3"=>"Grazie per aver archiviato questa email",
			...
			"DASHBOARD_offlineNews"=>"Notizie archiviate",
			"DASHBOARD_offlineNewsInfo"=>"Mostra solo le notizie archiviate",
			"DASHBOARD_noNews"=>"Nessuna notizia per il momento",
			"DASHBOARD_POLLS_addPoll"=>"Aggiungi un sondaggio",
			"DASHBOARD_POLLS_onlyVoted"=>"Sondaggi votati",
			"DASHBOARD_POLLS_onlyVotedInfo"=>"Mostra solo i sondaggi già votati",
			"DASHBOARD_POLLS_toVoteNb"=>"sondaggi non votati",
			"DASHBOARD_POLLS_voteSubmit"=>"Vota e vedi i risultati!",
			"DASHBOARD_POLLS_voteTooltip"=>"I voti sono anonimi: nessuno saprà la tua scelta di voto",
			"DASHBOARD_POLLS_votesNb"=>"Votate --NB_VOTES-- volte",
			"DASHBOARD_POLLS_votesNbBis"=>"Il sondaggio è stato votato --NB_VOTES-- volte",
			"DASHBOARD_POLLS_votedBy"=>"Votato da",
			"DASHBOARD_POLLS_noPolls"=>"Nessun sondaggio per il momento",
			...
			// Sondage/Polls
			"DASHBOARD_POLLS_titleQuestion"=>"Titolo / Domanda",
			"DASHBOARD_POLLS_multipleResponses"=>"Sono possibili più risposte per ogni voto",
			"DASHBOARD_POLLS_toVoteWithNews"=>"Mostra con le notizie (menu a sinistra)",
			"DASHBOARD_POLLS_publicVote"=>"Voto pubblico: la scelta dei votanti è pubblica",
			"DASHBOARD_POLLS_publicVoteInfo"=>"Si noti che il voto pubblico può costituire un ostacolo alla partecipazione al sondaggio",
			"DASHBOARD_POLLS_dateEnd"=>"Fine delle votazioni",
			"DASHBOARD_POLLS_responseList"=>"Risposte possibili",
			"DASHBOARD_POLLS_responseNb"=>"Risposta n°",
			"DASHBOARD_POLLS_responseAdd"=>"Aggiungi una risposta",
			"DASHBOARD_controlResponseNb"=>"Specificare almeno 2 risposte possibili",
			"DASHBOARD_POLLS_votedNotif"=>"Attenzione: non appena il sondaggio viene votato, non è più possibile modificare il titolo o le risposte",
			"DASHBOARD_POLLS_noResponseNotif"=>"Selezionare una risposta",
			"DASHBOARD_POLLS_exportPdf"=>"Scarica i risultati del sondaggio in formato pdf",
			"DASHBOARD_POLLS_exportDate"=>"risultato del sondaggio a partire da",
			...
			"FILE_folderAccessError"=>"Cartella sul server non accessibile",
			...
			"FILE_uploadSimpleMultiple"=>"Selezione di uno o più file",
			...
			"CALENDAR_importIgnoreOldEvt"=>"Non importare eventi più vecchi di un anno",
			"CALENDAR_importEvtPresent"=>"Già presente",
			"CALENDAR_importEvtPresentInfo"=>"Evento già presente nel calendario ?",
			...
			"CALENDAR_yearWeekNum"=>"Vedi settimana",
			"CALENDAR_periodNext"=>"Periodo successivo",
			"CALENDAR_periodPrev"=>"Periodo precedente",
			"CALENDAR_evtAffects"=>"Presenta il calendario",
			"CALENDAR_evtAffectToConfirm"=>"Per confermare il calendario",
			...
			"CALENDAR_evtEdit"=>"Modifica evento e assegnazioni ai calendari",
			"CALENDAR_evtDelete"=>"Cancellare evento",
			"CALENDAR_evtRemoveFromCal"=>"Rimuovi l'evento da calendario",
			"CALENDAR_evtRemoveFromDate"=>"Rimuovi l'evento in questa data",
			...
			"CALENDAR_evtAutorSortCrea"=>"Ordina per data di creazione (desc)",
			"CALENDAR_evtAutorSortBegin"=>"Ordina per data di inizio dell'evento (desc)",
			"CALENDAR_evtChangeTime"=>"Spostare l'evento?",
			...
			"CALENDAR_calendarAffectations"=>"Calendari in cui l'evento è visualizzato",
			...
			"CALENDAR_proposeEvtTooltipBis"=>"Possibilità di proporre l'evento : quindi confermato dal proprietario del calendario",
			...
			"CALENDAR_propositionNotif"=>"Notifica via email di ogni proposta di evento",
			...
			"FORUM_notifyLastPost"=>"Notifica via email",
			"FORUM_notifyLastPostTooltip"=>"Inviami una notifica via email per ogni nuovo messaggio",
			...
			"TASK_folderDateBegin"=>"Data di inizio più precoce",
			"TASK_folderDateEnd"=>"Data di fine più recente",
			...
			"MAIL_MODULE_DESCRIPTION"=>"Invia email con un clic!",
			"MAIL_OPTION_onlyAdminAccess"=>"Solo gli amministratori possono accedere al modulo e inviare email",
			"MAIL_specifyMail"=>"Grazie per aver inserito un indirizzo email",
			"MAIL_title"=>"Oggetto dell'email",
			"MAIL_description"=>"Messaggio email",
			"MAIL_historyTitle"=>"Cronologia delle email inviate",
			"MAIL_historyDelete"=>"Elimina le vecchie email",
			"MAIL_historyDeleteXDays"=>"Inviate almeno --NB_DAYS-- giorni fa",
			"MAIL_historyDeleteNotif"=>"Numero di email eliminate",
			"MAIL_delete"=>"Elimina questa email",
			"MAIL_resend"=>"Reinvia questa email",
			"MAIL_resendInfo"=>"Recupera il contenuto di questa email e lo integra direttamente nell'editor per un nuovo invio",
