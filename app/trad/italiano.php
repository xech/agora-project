...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"passwordInvalid"=>"La password deve contenere almeno 8 caratteri alfanumerici (idealmente con numeri, lettere e caratteri speciali)",
			...
			"userInscriptionNotif"=>"Notifica via email a ogni registrazione",
