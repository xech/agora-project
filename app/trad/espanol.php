...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"connectSpaceSwitchInfo"=>"Cambiar a un espacio de trabajo distinto a",
			...
			"passwordInvalid"=>"La contraseña debe contener al menos 12 caracteres alfanuméricos (idealmente con números, letras y caracteres especiales.)",
			...
			"record"=>"Registrar",
			"modify"=>"Editar",
			"modifyAndAccesRight"=>"Editar elemento y sus derechos de acceso",
			"validate"=>"Validar",
			"send"=>"Enviar",
			"sendTo"=>"Enviar a",
			...
			////	Envoi d'un email
			"MAIL_notifSendOk"=>"El correo se ha enviado correctamente",
			"MAIL_notifSendOkBis"=>"El correo de notificación se ha enviado correctamente",
			"MAIL_notifSendFail"=>"No se ha podido enviar el correo",
			"MAIL_recipients"=>"Destinatarios",
			"MAIL_recipientsTooltip"=>"Elegir los destinatarios del correo electrónico",
			...
			"downloadBackToApp"=>"Volver a Omnispace",
			...
			"userInscriptionNotif"=>"Notificar a los administradores por correo electrónico cada nuevo registro",
			...
			"export_vcard"=>"Exportar en formato vCard",
			...
			////	Header
			"HEADER_spaceSwitch"=>"Mostrar este espacio de trabajo",
			"HEADER_manageAllSpaces"=>"Administrar todos los espacios",
			"HEADER_displayAdmin"=>"Visualización de Administrador",
			"HEADER_displayAdminInfo"=>"Vista Administrador: Muestra todos los elementos presentes en el espacio (calendarios, carpetas, etc.)",
			...
			"MESSENGER_visioProposeToUsers"=>"Iniciar una videoconferencia entre",
			...
			"EDIT_showAllUsersInfo"=>"Mostrar los usuarios de todos los espacios de trabajo",
			...
			"SPACE_config"=>"Gestionar el espacio de trabajo",
			"SPACE_configInfo"=>"Gestionar el espacio, sus módulos (herramientas) y las asignaciones a los usuarios",
			"SPACE_space"=>"Espacio",
			...
			"SPACE_publicSpaceRGPD"=>"Tu espacio es público: si contiene datos personales (teléfono, dirección, etc.) recuerda especificar una contraseña para cumplir con el RGPD: Reglamento General de Protección de Datos",
			...
			"USER_spaceNoAffectation"=>"El usuario no está asignado a ningún espacio",
			...
			"DASHBOARD_offlineNews"=>"Noticias archivadas",
			"DASHBOARD_offlineNewsInfo"=>"Mostrar solo las noticias archivadas",
			"DASHBOARD_noNews"=>"No hay noticias por el momento",
			"DASHBOARD_POLLS_addPoll"=>"Añadir una encuesta",
			"DASHBOARD_POLLS_onlyVoted"=>"Encuestas votadas",
			"DASHBOARD_POLLS_onlyVotedInfo"=>"Mostrar solo las encuestas ya votadas",
			"DASHBOARD_POLLS_toVoteNb"=>"encuestas no votadas",
			"DASHBOARD_POLLS_voteSubmit"=>"Votar y ver los resultados !",
			"DASHBOARD_POLLS_voteTooltip"=>"Los votos son anónimos : nadie sabrá su elección de voto",
			"DASHBOARD_POLLS_votesNb"=>"Votada --NB_VOTES-- veces",
			"DASHBOARD_POLLS_votesNbBis"=>"La encuesta fue votada --NB_VOTES-- veces",
			"DASHBOARD_POLLS_votedBy"=>"Votada por",
			"DASHBOARD_POLLS_noPolls"=>"No hay encuesta por el momento",
			...
			// Sondage/Polls
			"DASHBOARD_POLLS_titleQuestion"=>"Título / Pregunta",
			"DASHBOARD_POLLS_multipleResponses"=>"Varias respuestas posibles para cada voto",
			"DASHBOARD_POLLS_toVoteWithNews"=>"Mostrar con noticias (menú izquierdo)",
			"DASHBOARD_POLLS_publicVote"=>"Voto público: la elección de los votantes es pública",
			"DASHBOARD_POLLS_publicVoteInfo"=>"Tenga en cuenta que la votación pública puede ser una barrera para la participación en la encuesta.",
			"DASHBOARD_POLLS_dateEnd"=>"Fin de votaciones",
			"DASHBOARD_POLLS_responseList"=>"Posibles respuestas",
			"DASHBOARD_POLLS_responseNb"=>"Respuesta n°",
			"DASHBOARD_POLLS_responseAdd"=>"Añadir una respuesta",
			"DASHBOARD_controlResponseNb"=>"Por favor, especifique al menos 2 respuestas posibles",
			"DASHBOARD_POLLS_votedNotif"=>"Atención: tan pronto como se vota la encuesta, ya no es posible cambiar el título o las respuestas",
			"DASHBOARD_POLLS_noResponseNotif"=>"Por favor seleccione una respuesta",
			"DASHBOARD_POLLS_exportPdf"=>"Descarga los resultados de la encuesta en pdf",
			"DASHBOARD_POLLS_exportDate"=>"resultado de la encuesta al",
			...
			"FILE_folderAccessError"=>"Los directorios del servidor no son accesible",
			...
			"CALENDAR_displayAdmin"=>"Vista Administrador: Muestra todos los calendarios presentes en el espacio",
			"CALENDAR_displayHide"=>"Mostrar / Ocultar calendario",
			...
			"CALENDAR_yearWeekNum"=>"Ver la semana",
			"CALENDAR_periodNext"=>"Período siguiente",
			"CALENDAR_periodPrev"=>"Período anterior",
			"CALENDAR_evtAffects"=>"Presente en el calendario",
			"CALENDAR_evtAffectToConfirm"=>"Por confirmar en el calendario",
			...
			"CALENDAR_evtEdit"=>"Editar evento y asignaciones a los calendarios",
			"CALENDAR_evtDelete"=>"Eliminar evento",
			"CALENDAR_evtRemoveFromCal"=>"Eliminar el evento del calendario",
			"CALENDAR_evtRemoveFromDate"=>"Eliminar el evento en esta fecha",
			...
			"CALENDAR_evtChangeTime"=>"¿ Mover el evento ?",
			...
			"CALENDAR_calendarAffectations"=>"Calendarios donde se muestra el evento",
			...
			"CALENDAR_proposeEvtTooltipBis"=>"Opción de proponer el evento : Luego validado por el propietario del calendario",
			...
			"MAIL_OPTION_onlyAdminAccess"=>"Solo los administradores pueden acceder al módulo y enviar correos electrónicos",
			...
			"MAIL_historyDelete"=>"Eliminar correos electrónicos antiguos",
			"MAIL_historyDeleteXDays"=>"Enviados hace al menos --NB_DAYS-- días",
			"MAIL_historyDeleteNotif"=>"Número de correos electrónicos eliminados",
