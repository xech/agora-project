...
class Trad extends Txt
{
	...
	public static function loadTradsLang()
	{
		...
		self::$trad=array(
			...
			"copyUrlTooltip"=>"Este enlace/url permite el acceso directo al elemento: <br> Puede integrarse en una noticia, un tema de foro, un correo electrónico, un blog (acceso externo), etc.",
