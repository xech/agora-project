...
class Trad extends Txt
{
	...
	public static function loadTrads()
	{
		...
		self::$trad=array(
			...
			"sendMailTo"=>"Enviar un correo electrónico a",
			...
			"copyUrlTooltip"=>"Copiar el enlace para compartir (URL) para enviarlo por correo electrónico, mensajería, etc.",
			...
			"resetPassword2"=>"Indique su correo electrónico para restablecer su contraseña de acceso",
			...
			"OBJ_mail"=>"correo electrónico",     				//ModMail
			"OBJ_mail_TO"=>"al correo electrónico",
			...
			"MAIL_sendNotOk"=>"El correo electrónico no se pudo enviar..",
			...
			"MAIL_addReplyToTooltip"=>"Añadir mi correo electrónico en el campo ''Responder a'' <br> Tenga en cuenta que con esta opción su correo electrónico puede llegar en spam en algunas mensajerías",
			...
			"MAIL_maxFileSizeNotif"=>"El archivo no se agregó al correo electrónico porque es demasiado grande",
			"MAIL_sendMail"=>"Enviar correo electrónico",
			...
			"EDIT_notifMailTooltip"=>"La notificación se enviará a las personas asignadas --OBJ_LABEL_TO--",
			...
			"INSTALL_dataDashboardNews"=>  '<h3>¡Bienvenido a tu nuevo espacio de trabajo colaborativo!</h3>
											...
											<h4><a href="?ctrl=user&action=SendInvitation" class="lightboxOpenHref"><img src="app/img/mail.png">Enviar invitaciones por correo electrónico para unirse al espacio</a></h4>',
			...
			"AGORA_gOAuthTooltip"=>"Los usuarios pueden conectarse más fácilmente a su espacio a través de su cuenta de Google : para eso, un correo electrónico <i>@gmail.com</ i> ya debe estar registrado en la cuenta del usuario",
			...
			"USER_sendInvitationTooltip"=>"Enviar invitaciones por correo electrónico para unirse al espacio actual :<br> Una vez validada la invitación, se crea automáticamente una cuenta de usuario para la persona interesada.",
			...
			"MAIL_MODULE_DESCRIPTION"=>"Enviar mensajes de correo electrónico con un solo clic !",
