...
foreach($newsList as $tmpNews)
{
	echo $tmpNews->objContainerMenu('vNewsContainer '.$infiniteScrollHidden).
			...
			'<div class="vNewsDetail">'.
				...
				(!empty($tmpNews->dateOffline) ?	'<div '.Txt::tooltip(Txt::trad("DASHBOARD_dateOffline").' : '.Txt::dateLabel($tmpNews->dateOffline,"dateBasic")).'><img src="app/img/dateEnd.png"> '.Txt::dateLabel($tmpNews->dateOffline,"dateBasic").'</div>'  : null).
