...
foreach($newsList as $tmpNews)
{
	echo $tmpNews->objContentDiv('vNewsContainer '.$infiniteScrollHidden).
			...
			'<div class="vNewsDetail">'.
				...
				(!empty($tmpNews->dateOnline) ?		'<div '.Txt::tooltip(Txt::trad("DASHBOARD_dateOnline").' : '.Txt::dateLabel("dateNum",$tmpNews->dateOnline)).'>&nbsp; <img src="app/img/datePending.png"> '.Txt::dateLabel("dateNum",$tmpNews->dateOnline).'</div>'  : null).
