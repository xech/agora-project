...
foreach($pollsList as $tmpPoll)
{
	...
	$imgIsFinished=($tmpPoll->isFinished())  ?  "<div class='vPollsDateEnd'><img src='app/img/dashboard/pollDateEnd.png'> ".Txt::trad("DASHBOARD_dateEnd")." : ".Txt::dateLabel($tmpPoll->dateEnd,"dateFull")."</div>"  :  null;
