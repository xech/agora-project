...
foreach($pollsList as $tmpPoll)
{
	...
	echo $tmpPoll->objContentDiv('vPollsContainer '.$infiniteScrollHidden).
			...
			'<div class="vPollsDetails">'.
				(!empty($tmpPoll->dateEnd)  ?  '<div><img src="app/img/dateEnd.png"> '.Txt::trad("DASHBOARD_POLLS_dateEnd").' : '.Txt::dateLabel("dateDefault",$tmpPoll->dateEnd).'</div>'  :  null).
