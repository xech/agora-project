...
{
	////	Responsive : lance via le browser (cf. Appli Ionic)  ||  Mode normal : ajoute le nom de l'user dans l'Url (note: pas pour IOS, sinon cela bloque l'affichage)
	visioURL+=(isTouchDevice()==false)	 ?  "#omnispaceApp_action=getFile_nameMd5"  :  "#userInfo.displayName=%22"+labelVisioUser+"%22";
